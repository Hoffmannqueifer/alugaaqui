...
import com.alugueaqui.servicies.ClienteService;
...
import com.alugueaqui.web.dtos.mappers.ClienteMapper;
...
public class ClienteController {
    ...
    @Operation(summary = "Buscar um cliente", description = "Recurso para buscar um cliente pelo ID. Requisção exige " +
            "o uso de um bearer token. Acesso restrito a usuários com perfil 'ADMIM' ou 'FUNCIONARIO'.",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Cliente não encontrado",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation =
                                    ErrorMessage.class))),
                    @ApiResponse(responseCode = "403", description = "Recurso não permitido sem login",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation =
                                    ErrorMessage.class)))
    ...
    @Operation(summary = "Recuperar lista de funcionarios",
            description = "Requisição exige uso de um bearer token. Acesso restrito ao perfil 'ADMIM' ou 'FUNCIONARIO' ",
            security = @SecurityRequirement(name = "security"),
            parameters = {
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "403", description = "Recurso não permito ao perfil 'ADMIM' ou 'FUNCIONARIO'",
                            content = @Content(mediaType = " application/json;charset=UTF-8",
